...
if(isset($_POST['name']))
{
    ...
    $sql= "INSERT INTO `doctor`(`doc_ssn`,`doc_name`,`doc_exp`,`doc_spec`) VALUES ('$docno', '$name', '$yr', '$spec');";
    //echo $sql
...
<div class="form-container">
    ...
    if($insert)
    {
    echo '<p class="SubmitMsg">Doctor Registered!!!  Welcome to IITG Hospital</p>';
    }
    ?>
    <form action="doc_registration.php" method="post">
        <label for="docno">SSN:</label>
        <input type="text" id="docno" name="docno" required>
